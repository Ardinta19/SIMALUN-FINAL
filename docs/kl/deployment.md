...
> **Khusus Hostinger:** ada panduan terpisah yang lebih lengkap dan
> langkah-demi-langkah di [`deployment-hostinger.md`](deployment-hostinger.md)
> (mencakup hPanel, SSH, queue via cron, document root, SSL, troubleshooting).

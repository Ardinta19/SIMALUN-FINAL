...
body{font-family:'Plus Jakarta Sans',sans-serif;background:var(--surface);color:var(--ink);min-height:100vh;padding-bottom:calc(200px + env(safe-area-inset-bottom,0px));overflow-x:hidden;}

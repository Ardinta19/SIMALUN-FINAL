...
/* ── Layar pendek: rapatkan agar konten tidak terpotong; sisanya bisa di-scroll ── */
@media (max-height: 740px) {
  #logo-zone { height:28%; }
  #carousel-viewport { top:28%; }
  .panel-icon-wrap { height:clamp(96px, calc(52vh - 200px), 170px); }
}
@media (max-height: 620px) {
  #logo-zone { height:24%; gap:.2rem; }
  #carousel-viewport { top:24%; }

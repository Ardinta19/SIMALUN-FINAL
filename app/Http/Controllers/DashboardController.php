...
class DashboardController extends Controller
{
    ...
    public function admin()
    {
        ...
        // Total order 30 hari — dipakai donut analitik untuk hitung porsi
        // "lainnya" (di luar top 5) supaya distribusi layanan akurat.
        $totalOrder30d = Cache::remember('dashboard.admin.total-order-30d', $cacheTtl, function () use ($sejak) {
            return Order::where('created_at', '>=', $sejak)->count();
        });

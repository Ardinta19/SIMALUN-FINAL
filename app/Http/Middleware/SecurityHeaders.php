...
class SecurityHeaders
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // Anti back-button cache untuk halaman terautentikasi.
        // Tanpa ini, setelah logout user bisa menekan tombol "kembali"
        // dan browser menampilkan halaman dashboard/role dari bfcache
        // (data sensitif masih terlihat walau sesi sudah mati).
        // no-store memaksa browser selalu minta ulang ke server, yang
        // akan menolak karena sesi sudah invalid.
        if (Auth::check()) {
